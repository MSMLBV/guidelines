...
```
https://msml.nl/over-ons
https://msml.nl/blog/van-piloot-naar-software-developer
```
...
:::tip
```php
Route::get('over-ons', [OpenSourceController::class, 'index']);
```
:::
...
:::warning
```php
Route::get('over-ons', 'OpenSourceController@index');
```
:::
